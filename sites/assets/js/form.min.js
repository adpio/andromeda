...
frappe.templates["grid_body"] = '<div> <div class="form-grid"> <div class="grid-heading-row"></div> <div class="grid-body"> <div class="rows"></div> <div class="grid-empty text-center hide">{%= __("No Data") %}</div> <div class="small form-clickable-section grid-footer"> <div class="row"> <div class="col-sm-6"> <a href="#" class="grid-add-multiple-rows btn btn-xs btn-default hide" style="margin-right: 10px;"> {%= __("Add multiple rows") %}</a> <a href="#" class="btn btn-xs btn-default grid-add-row"> {%= __("Add new row") %}</a> </div> <div class="col-sm-6 text-right"> <a href="#" class="grid-download btn btn-xs btn-default hide" style="margin-left: 10px;"> {%= __("Download") %}</a> <a href="#" class="grid-upload btn btn-xs btn-default hide" style="margin-left: 10px;"> {%= __("Upload") %}</a> </div> </div> </div> </div> </div> </div> ';
...
frappe.ui.form.Grid=Class.extend({init:function(opts){$.extend(this,opts);this.fieldinfo={};this.doctype=this.df.options;this.template=null;this.multiple_set=false;if(this.frm.meta.__form_grid_templates&&this.frm.meta.__form_grid_templates[this.df.fieldname]){this.template=this.frm.meta.__form_grid_templates[this.df.fieldname];}
...
this.wrapper.find(".grid-empty").toggleClass("hide",!!data.length);if(this.is_editable()){this.wrapper.find(".grid-footer").toggle(true);if(this.cannot_add_rows){this.wrapper.find(".grid-add-row, .grid-add-multiple-rows").addClass('hide');}else{this.wrapper.find(".grid-add-row").removeClass('hide');if(this.multiple_set){this.wrapper.find(".grid-add-multiple-rows").removeClass('hide')}}
this.make_sortable($rows);}else{this.wrapper.find(".grid-footer").toggle(false);}
