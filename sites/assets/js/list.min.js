...
this.make_bulk_assignment();this.make_bulk_printing();this.page.add_menu_item(__("Add to Desktop"),function(){frappe.add_to_desktop(me.doctype,me.doctype);},true);},make_bulk_assignment:function(){var me=this;me.page.add_menu_item(__("Assign To"),function(){docname=[];$.each(me.get_checked_items(),function(i,doc){docname.push(doc.name);})
